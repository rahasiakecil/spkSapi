 ...
 <!--breadcrumbs start-->
    ...
    <div class="item form-group">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <img src="<?php echo base_url() ?>upload/tinggi1.png" style="width: 150px">
          <img src="<?php echo base_url() ?>upload/tinggi2.png" style="width: 150px">
        </div>
        <div class="col-md-6">
          <table>
            <tr>
            ...
            <tr>
              <td class="center">1 - Pendek (130 cm)</td>
              <td class="center">2 - Sedang (142 cm)</td>
              <td class="center">3 - Tinggi (154 cm)</td>
            </tr>
          </table>
        </div>
      </div>
      ...
      <div class="item form-group">
        <label class="control-label col-md-2 col-sm-2 col-xs-12">Lebar Dada</label>
        <div class="col-md-6">
          <table>
          <tr>
              <td class="center"> 
                <input type="radio" name="ligamentum_tengah" id="" required value="1" required>
                <img src="<?php echo base_url() ?>upload/dada1.png" style="width: 150px">
                </td>
              <td class="center"> 
                <input type="radio" name="ligamentum_tengah" id="" required value="2" required >
                <img src="<?php echo base_url() ?>upload/dada2.png" style="width: 150px"></td>
              <td class="center"> 
                <input type="radio" name="ligamentum_tengah" id="" required value="3" required>
      ...
      <div class="item form-group">
        <label class="control-label col-md-2 col-sm-2 col-xs-12">Letak Puting Depan</label>
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> 
                <input type="radio" name="sudut_pinggul" id="" value="1" required>
                <img src="<?php echo base_url() ?>upload/letak_puting_depan1b.png" style="width:150px;"></td>
              <td class="center"> 
                <input type="radio" name="sudut_pinggul" id="" value="2" required>
                <img src="<?php echo base_url() ?>upload/letak_puting_depan2b.png" style="width: 150px"></td>
              <td class="center"> 
                <input type="radio" name="sudut_pinggul" id="" value="3" required>
                <img src="<?php echo base_url() ?>upload/letak_puting_depan3b.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1 - Keluar Dari Kuartir</td>
              <td class="center">2 - Ditengah Kuartir</td>
              <td class="center">3 - Didalam Kuartir</td>
            </tr>
          </table>
        </div>
      </div>
      ...
      <div class="item form-group">
        <label class="control-label col-md-2 col-sm-2 col-xs-12">Posisi Puting Belakang</label>
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> 
                <input type="radio" name="lebar_pinggul" id="" value="1" required>
                <img src="<?php echo base_url() ?>upload/posisi_puting_belakang1a.png" style="width: 150px"></td>
              <td class="center"> 
                <input type="radio" name="lebar_pinggul" id="" value="2" required>
                <img src="<?php echo base_url() ?>upload/posisi_puting_belakang2a.png" style="width: 150px"></td>
              <td class="center"> 
                <input type="radio" name="lebar_pinggul" id="" value="3" required>
                <img src="<?php echo base_url() ?>upload/posisi_puting_belakang3a.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1 - Diluar</td>
              <td class="center">2 - Ditengah Kuartir</td>
              <td class="center">3 - Didalam Kuartir</td>
            </tr>
          </table>
