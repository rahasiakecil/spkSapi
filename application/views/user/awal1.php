          ...
          <table>
            <tr>
              <td class="center"> 
                ...
                <img src="<?php echo base_url() ?>upload/dada1.png" style="width: 150px"></td>
              <td class="center"> 
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="sudut_pinggul" class="form-control" required>
              <option value="" selected="" disabled="">Sudut Pinggul | Skala +4 ~ -12cm</option>
        ...
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> 
                <input type="radio" name="sudur_pinggul" id="" value="1" required>
                <img src="<?php echo base_url() ?>upload/sudut_pinggul1.png" style="width: 150px"></td>
              <td class="center"> 
                <input type="radio" name="sudur_pinggul" id="" value="2" required>
        ...
        <div class="col-md-6">
          <table>
            <tr>
              ...
              <td class="center"> 
                <input type="radio" name="lebar_ppinggul" id="" value="3" required>
