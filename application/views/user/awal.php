        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <h1>Proses Pemilihan 4</h1>
                </div>
                <div class="col-lg-8 col-sm-8">
                    <ol class="breadcrumb pull-right">
                        <li><a href="<?php echo base_url() ?>user">Home</a></li>
                        <li class="active">Proses Pemilihan 4</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container career-inner">
        <div class="row">
            <div class="col-md-12 career-head">
                <h1 class="wow fadeIn">Proses Pemilihan 4</h1>

            </div>
        </div>
        <hr>
        <form class="form-horizontal" role="form" method="get" action="<?php echo base_url() ?>user/proses_4/p/" autocomplete="off">
        <div class="row">
    ...
    <div class="item form-group">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="kedalaman_ambing" class="form-control" required>
              ...
              <option value="1" <?php if( @$kedalaman_ambing == "1" ){echo 'selected="selected"';} ?>>1 - Dangkal</option>
              <option value="2" <?php if( @$kedalaman_ambing == "2" ){echo 'selected="selected"';} ?>>2 - Sedang </option>
              <option value="3" <?php if( @$kedalaman_ambing == "3" ){echo 'selected="selected"';} ?>>3 - Dibawah HOCK atau sama dengan HOCK</option>
          </select>

          <input type="radio" name="kedalaman_ambing" id="" value="1" <?php if( @$kedalaman_ambing == "1" ){echo 'selected="selected"';} ?>> <img src="<?php echo base_url() ?>upload/kedalaman_ambing1.png" style="width: 150px"> 1
          <input type="radio" name="kedalaman_ambing" id="" value="2"> <img src="<?php echo base_url() ?>upload/kedalaman_ambing2.png" style="width: 150px"> 2
        </div>
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/kedalaman_ambing1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/kedalaman_ambing2.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/kedalaman_ambing3.png" style="width: 150px"></td>
            </tr>
            <tr>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/ligamentum1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/ligamentum2.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/ligamentum3.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1</td>
              <td class="center">2</td>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="sudut_pinggul" class="form-control" required>
              <option value="" selected="" disabled="">Suduh Pinggul | Skala +4 ~ -12cm</option>
              <option value="1" <?php if( @$sudut_pinggul == "1" ){echo 'selected="selected"';} ?>>1 - Ping Lebih Tinggi (+4 ~ -2cm)</option>
              <option value="2" <?php if( @$sudut_pinggul == "2" ){echo 'selected="selected"';} ?>>2 - Ekstrim Rendah (-12)</option>
              <option value="3" <?php if( @$sudut_pinggul == "3" ){echo 'selected="selected"';} ?>>3 - Sedang (-4 ~ -10cm)</option>
          </select>
        </div>
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/sudut_pinggul1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/sudut_pinggul2.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/sudut_pinggul3.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1</td>
              <td class="center">2</td>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
           <select name="lebar_pinggul" class="form-control" required>
              <option value="" selected="" disabled="">Lebar Pinggul | Skala 10 ~ 26cm</option>
        ...
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/lebar_pinggul1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/lebar_pinggul2.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/lebar_pinggul3.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1</td>
              <td class="center">2</td>
      ...
      <div style="display: none;">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="pertautan_ambing" class="form-control">
        ...
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/pertautan_ambing1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/pertautan_ambing2.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/pertautan_ambing3.png" style="width: 150px"></td>
            </tr>
            <tr>
              <td class="center">1</td>
              <td class="center">2</td>
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4">
          <select name="lebar_dada" class="form-control">
              <option value="" selected="" disabled="">Lebar Dada | Skala 13 ~ 29cm</option>
        ...
        <div class="col-md-6">
          <table>
            <tr>
              <td class="center"> <img src="<?php echo base_url() ?>upload/dada1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/dada1.png" style="width: 150px"></td>
              <td class="center"> <img src="<?php echo base_url() ?>upload/dada1.png" style="width: 150px"></td>
            </tr>
            <tr>
                                      ...
                                      <tbody>
                                        ...
                                        <?php
                                            if(abs(round($total_output[$no])) == 1){
                                                $status = "Disarankan";
                                                $anfis_keterangan="Sapi Perah Friesian Holstein (FH) Dengan <br>Nama Pemilik : ".$nama." t<br>Disarankan Untuk menjadi indukan sapi.";
                                            }else{
