    ...
    <div class="x_panel">
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="tinggi_badan" class="form-control" required>
      ...
      <div class="item form-group">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="kedalam_tubuh" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
           ...
           <select name="angularity" class="form-control" required>
      ...
      <div class="item form-group">
        <label class="control-label col-md-3 col-sm-2 col-xs-12">Suduh Pinggul</label>
        <div class="col-md-4 col-sm-6 col-xs-12">
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
           <select name="kaki_belakang" class="form-control" required>
       ...
       <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="bentuk_kaki" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="sudut_kuku" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          ...
          <select name="letak_puting_depan" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="panjang_puting" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <select name="tinggi_ambing_belakang" class="form-control" required>
      ...
      <div class="item form-group">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
           <select name="posisi_puting_belakang" class="form-control" required>
      ...
      <div class="col-md-12 col-md-offset-5">
        <a href="<?php echo base_url() ?>spk/akurasi_data"><button type="button" class="btn btn-warning">Batal</button></a>
